 ...
 * Optional Parameters.
 */
export interface NetCoreMicroserviceSampleApiSayHelloOptionalParams extends msRest.RequestOptionsBase {
  howNice?: number;
}
...
/**
 * Contains response data for the sayHello operation.
 */
